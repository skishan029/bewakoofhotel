...
<body class="hold-transition login-page">
    ...
    <!-- /.login-logo -->
        ...
        @if($message = session('admin_signin'))
            <x-callout-message :type="$message[1]" :message="$message[0]" />
        @endif
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-header text-center remove-bottom-border">
                <a href="{{ route('admin.index') }}" class="h4"><b>Admin</b></a>
            </div>
            <div class="card-body">
                <form action="" method="post" id="form_login">
                    
                    <div class="input-group">
                        <input type="email" class="form-control rounded-0" placeholder="Email" required="" name="email" data-parsley-errors-container="#emai_message">
                    ...
                    <div id="emai_message" class="mb-3"></div>
                    <div class="input-group">
                        <input type="password" class="form-control rounded-0 login-pswd" placeholder="Password" required=""  name="password" data-parsley-errors-container="#password_message" minlength="6" autocomplete="off">
                        <div class="input-group-append">
                            <div class="input-group-text rounded-0">
                    ...
                    <div id="password_message" class="mb-3"></div>
                    <div class="form-group custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="exampleCheck1" value="1" onclick="myFunction(this.value)">
                            <label class="custom-control-label" for="exampleCheck1">Show Password</label>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" name="submit" class="btn btn-primary btn-flat btn-block">Sign In</button>
                        </div>
                    </div>
                </form>
                {{-- <p class="mb-1">
