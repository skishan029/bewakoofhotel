...
// $status = 'Opend';
@endphp
<div class="Shop-pages shop-details pt-40 mb-40">
    <div class="container">
                    ...
                    <div class="single-widgets widget_search">
                        <form action="" method="get">
                            ...
                            <div class="wp-block-search__inside-wrapper ">
                                <input type="search" id="wp-block-search__input-1" class="wp-block-search__input" name="search" value="{{ request('search') }}" placeholder="Search Food..." aria-label="Search">
